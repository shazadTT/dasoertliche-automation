...
_PORTAL_SYNONYME = {
    ...
    "11880": {
        ...
        # 11880 kennt keine Terrassenüberdachung/Spanndecke/Badsanierung – nächstliegende Kategorien:
        "terrassenüberdachung": ["Wintergarten", "Metallbau", "Zimmerei"],
        "überdachung":        ["Wintergarten", "Metallbau"],
        "spanndecke":         ["Innenausbau", "Raumausstatter"],
        "badsanierung":       ["Sanitärinstallation", "Sanitär-Kundendienst"],
        "bodensanierung":     ["Bodenleger"],
        "heizung":            ["Heizungsinstallation"],
        "wärmepumpe":         ["Wärmepumpe", "Heizungsinstallation"],
        "entrümpelung":       ["Entrümpelung"],
        "dachdecker":         ["Dachdecker"],
        "tischler":           ["Tischler"],
        "maler":              ["Maler"],
        "fenster":            ["Fenster", "Fensterbau"],
        "zimmerer":           ["Zimmerei"],
    },
    "telefonbuch": {
        "rohrreinigung":      ["Rohrreinigung"],
